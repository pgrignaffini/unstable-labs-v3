    ...
    <>
      ...
      <main className="container mx-auto flex min-h-screen flex-col items-center space-y-10 justify-evenly lg:justify-center p-4">
        <div className="relative w-full">
          ...
          <p className="absolute bottom-2/3 lg:bottom-2 right-2 text-white text-[0.5rem]">artwork by <Link className="text-acid underline" href="https://www.pixilart.com/w0ah" target="_blank">w0ah</Link></p>
        </div>
