        ...
        <>
            ...
            <main className="container mx-auto flex min-h-screen flex-col items-center space-y-10 mt-10 p-4">
                ...
                <p className="lg:text-justify">
                    ...
                    To get started head over to the <Link href="/brewery" className="text-acid underline">brewery</Link> and pick up some vials. Then, make your way to the  <Link href="/" className="text-acid underline">lab</Link> and start brewing something beautiful.<br />
